...
# Directories
IN_DIR = "/home/stoyelq/my_hot_storage/dfobot/crab/raw"

OUT_DIR = "/home/stoyelq/my_hot_storage/dfobot/crab/classed/"
CSV_FILE = "/home/stoyelq/my_hot_storage/dfobot/crab/classes.csv"
...
class ImageReviewApp:
    def __init__(self, root):
        ...
        self.good_button = tk.Button(self.button_frame, text="Clean (C)", width=10,
                                     command=lambda: self.record_response("0"))
        self.good_button.pack(side=tk.LEFT, padx=10)

        self.bad_button = tk.Button(self.button_frame, text="Dirty (D)", width=10,
        ...
        self.root.bind('<s>', lambda e: self.record_response("4")) # stones/big rocks
        self.root.bind('<n>', lambda e: self.record_response("5")) # no catch
