...
METADATA_CSV_PATH = "/home/stoyelq/my_hot_storage/dfobot_working/crab/classes/classes.csv"
METADATA_COLUMNS = ['tow_type' ]

class CrabImageFolderCustom(ImageFolderCustom):

    def __init__(self, targ_dir, transform=None, col_name="tow_type"):
...
def get_crab_dataloader(batch_size, max_size=None, config_dict=None):
    ...
    image_datasets = {x: CrabImageFolderCustom(os.path.join(data_dir, x), data_transforms[x], col_name=COL_NAME) for x in ['train', 'val']}
