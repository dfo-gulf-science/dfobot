...
from model.model_utils import ClassifierModel, load_model_from_log_file, AugmentedModel
...
# WEIGHTS_PATH = "/home/stoyelq/my_hot_storage/dfobot_working/run_logs/066__2025-11-24/trained_weights.pth"
device = "cuda:1"
def get_dfobot():
    config_dict = {
        'NUM_WORKERS': 1,
    ...
    # bot = AugmentedModel(num_outputs=1, metadata_length=1)
...
y_pred, y_true = make_bot_plot(bot, 500, dataloader, device, title=str(WEIGHTS_PATH.split("/")[-2]))
